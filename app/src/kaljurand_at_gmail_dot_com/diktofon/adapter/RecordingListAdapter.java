...
public class RecordingListAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.list_item_position = (TextView) convertView.findViewById(R.id.list_item_position);
			holder.list_item_title = (TextView) convertView.findViewById(R.id.list_item_title);
			holder.list_item_meta = (TextView) convertView.findViewById(R.id.list_item_meta);
			holder.list_item_trans = (TextView) convertView.findViewById(R.id.list_item_trans);
			holder.list_item_tags = (TextView) convertView.findViewById(R.id.list_item_tags);
