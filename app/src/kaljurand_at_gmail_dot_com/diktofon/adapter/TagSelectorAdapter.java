...
public class TagSelectorAdapter extends BaseAdapter {
    ...
    private final Set<String> mSelectedTags = new HashSet<>();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.list_item_edittag_title = convertView.findViewById(R.id.list_item_edittag_title);
            holder.list_item_edittag_state = convertView.findViewById(R.id.list_item_edittag_state);
