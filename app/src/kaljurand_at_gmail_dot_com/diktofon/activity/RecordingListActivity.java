...
public class RecordingListActivity extends AbstractDiktofonListActivity {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        switch (requestCode) {
            case ACTIVITY_SELECT_TAGS:
                ...
                mRecordings.setTags(new HashSet<>(Arrays.asList(selectedTags)));
                refreshGui();
                break;
            case ACTIVITY_SELECT_TAGS_FOR_SORT:
                ...
                mRecordings.sort(new Recording.TagComparator(new HashSet<>(Arrays.asList(selectedTagsForSort))));
                refreshAdapter();
                break;
    ...
    private void requestMultiplePermissions() {
        ...
        requestPermissions(remainingPermissions.toArray(new String[remainingPermissions.size()]), PERMISSIONS_MULTIPLE_REQUEST);
    }
